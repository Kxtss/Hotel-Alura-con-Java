...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		super("Reserva");
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/hotel/imagenes/aH-40px.png")));
		...
		lblCheckIn.setBounds(68, 136, 180, 14);
		lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckIn);

		JLabel lblCheckOut = new JLabel("FECHA DE CHECK OUT");
		lblCheckOut.setForeground(SystemColor.textInactiveText);
		lblCheckOut.setBounds(68, 221, 202, 14);
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/hotel/imagenes/Ha-100px.png")));

		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/hotel/imagenes/reservas-img-3.png")));

		JLabel lblValor = new JLabel("VALOR DE LA RESERVA");
		lblValor.setForeground(SystemColor.textInactiveText);
		lblValor.setBounds(72, 303, 204, 14);
		...
		txtFechaEntrada.getCalendarButton()
				.setIcon(new ImageIcon(ReservasView.class.getResource("/hotel/imagenes/icon-reservas.png")));
		...
		labelSiguiente.setBackground(Color.WHITE);
	...
	/**
	 * Crea y aplica el metodo para calcular el valor de la reserva
	 * 
	 * Si se descomenta el codigo se puede visualizar en consola el proceso
	 */
	private void setValorReserva() {
		// Descomentando las lineas se puede ver en consola lo que hace

//        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");

		if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
//            System.out.println("Fecha entrada: " + dateFormat.format(txtFechaEntrada.getDate()));
//            System.out.println("Fecha salida: " + dateFormat.format(txtFechaSalida.getDate()));

			// Asignar el valor calculado a valorReserva
			valorReserva = calcularValor(txtFechaEntrada.getDate(), txtFechaSalida.getDate());
...
//            System.out.println(txtFormaPago.getSelectedItem());
	...
	/**
	 * Sirve para hacer el calculo entre los dias elegidos, el valor de un dia es
	 * 20, este ira sumando 20 cada dia que se aleje del inicial (20, 40, 60,
	 * etc...) que esta valorizado en Dolares
	 * 
	 * @param fechaEntrada
	 * @param fechaSalida
	 * @return
	 */
	private BigDecimal calcularValor(java.util.Date fechaEntrada, java.util.Date fechaSalida) {
		...
		long dias = ChronoUnit.DAYS.between(localDateEntrada, localDateSalida) + 1;
	...
	/*
	 * Se hace uso del metodo para guardar la reserva y sus campos en la base datos
	 */
	// Guardar Reserva
	private void guardar() {
		if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
			...
			BigDecimal valor = valorReserva;

			String formaPago = txtFormaPago.getSelectedItem().toString();

			var reserva = new Reserva(fechaEntrada, fechaSalida, valor, formaPago);
