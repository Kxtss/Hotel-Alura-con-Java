...
public class MenuUsuario extends JFrame {
	 ...
	 */
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/hotel/imagenes/aH-40px.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/hotel/imagenes/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/hotel/imagenes/reservado.png")));
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				dispose();
				// Muestra en la tabla lo que hay en la DB
				busquedaController.limpiarTabla(modelo);
				busqueda.cargarTablaReserva();
				
				// Muestra en la tabla lo que hay en la DB
				busquedaController.limpiarTabla(modelo);
				busqueda.cargarTablaHuesped();
			}
		});
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/hotel/imagenes/pessoas.png")));
